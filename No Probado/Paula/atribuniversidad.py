class Universidad:
    ...
    def main():
        ...
        universidad3 =Universidad(
            nombre="EHU", ciudad="Bilbao", tipo="Pública", grados=["Derecho""Farmacia""Ingeniería Electrónica""Mecánica""Matemáticas""Arte""Biología""Ingeniería Informática""Criminología""Economía"]
        )
        universidad4 = Universidad(
             nombre="UPSAL", ciudad="Salamanca", tipo="Privada", grados=["Física""Medicina""Ingeniería Informática""Matemáticas""Derecho""Robótica""Geología""Filosofía""Criminología""Aviación"]   
        )
        universidad5 = Universidad(
            nombre="UHU", ciudad="Huelva", tipo="Pública", grados=["Ingeniería Mecánica""Farmacia""Biología""Lengua""Filosofía""Ingeniería Informática""Química""Historia de España""Matemáticas""Artes""Psicología""Artes""Física"]
        )
